...
<![endif]-->
		...
		<script src="<?php echo base_url()?>assets/theme/ac_master/js/jquery.easypiechart.min.js"></script>
		<script src="<?php echo base_url()?>assets/theme/ac_master/js/jquery.sparkline.min.js"></script>
