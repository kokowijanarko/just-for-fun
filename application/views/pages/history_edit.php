			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							<?php //echo array_values($this->session->userdata[0];die(); ?>
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" action="<?php echo base_url('index.php/History/history_edit_process');?>" role="form" method = "POST">
									<div class="form-group">
										<input type="hidden" name="id_history" value="<?php echo $hists->history_id; ?>">
										...
										<div class="col-sm-9">
											<select name="nama_inventaris" class="col-xs-10 col-sm-5" id="form-field-select-1">
												...
												<?php 
													foreach ($inventories as $invs) { 								
														if($invs->inv_id == $hists->history_inv_id){
															$selected = "selected";
														}else{
															$selected = "";
														}
														echo '<option value="'.$invs->inv_id.'"'.$selected.'>'. $invs->inv_name.'</option>';
													} 
												?>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="kondisi" class="col-xs-10 col-sm-5" id="form-field-select-1">
												<option value="">--Pilih--</option>
												<?php 
													foreach ($conditions as $conds) { 								
														if($conds->cond_id == $hists->history_condition_id){
															$selected = "selected";
														}else{
															$selected = "";
														}
														echo '<option value="'.$conds->cond_id.'"'.$selected.'>'. $conds->cond_name.'</option>';
													} 
												?>
											</select>
										</div>
