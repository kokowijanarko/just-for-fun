				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/User/User_add_process')?>" method="POST">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nama Pengguna </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="user_name" placeholder="Nama Asli Pengguna" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" name="username" placeholder="Nama Pengguna Untuk Login" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="fcol-xs-10 col-sm-5" id="form-field-8" placeholder="Keterangan" name="keterangan"></textarea>
										</div>
									</div>
