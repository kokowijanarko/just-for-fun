				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/fund/process')?>" method="POST">
									<div class="form-group hide">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Group </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="fund_id" value="<?php $val = !empty($fund->fund_id)?$fund->fund_id:null; echo $val;?>" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="group_name" name="fund_name" value="<?php $val = !empty($fund->fund_name)?$fund->fund_name:null; echo $val;?>" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>									
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="fcol-xs-10 col-sm-5" id="fund_desc"  placeholder="Default Text" name="fund_desc"><?php $val = !empty($fund->fund_desc)?$fund->fund_desc:null; echo $val;?></textarea>
										</div>
									</div>
