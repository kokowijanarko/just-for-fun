							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/Category/category_edit_process')?>" method="POST">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Kode Kategori </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="<?php echo $category_res->category_id;?>" name="id_kategori" placeholder="" class="col-xs-10 col-sm-5" readonly/>
										</div>
									</div>
									<div class="form-group">
