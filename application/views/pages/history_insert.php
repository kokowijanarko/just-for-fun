					...
					<div class="page-content">
						...
						<div class="row">
							...
							<?php //echo array_values($this->session->userdata[0];die(); ?>
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" action="<?php echo base_url('index.php/History/history_add_process');?>" role="form" method = "POST">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select name="kondisi" class="col-xs-10 col-sm-5" id="form-field-select-1">
												<option value="">--Pilih--</option>
												<?php foreach ($conditions as $conds) { ?>
													<option value="<?php echo $conds->cond_id; ?>"> <?php echo $conds->cond_name; ?> </option>
												<?php } ?>
											</select>
										</div>
									</div>
