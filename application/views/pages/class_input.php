				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/class_con/process')?>" method="POST">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> ID Golongan </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="class_id" value="<?php $class_id = !empty($class->class_id)?$class->class_id:null; echo $class_id;?>" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="class_name" name="class_name" value="<?php $class_id = !empty($class->class_name)?$class->class_name:null; echo $class_id;?>" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea class="fcol-xs-10 col-sm-5" id="class_desc"  placeholder="Default Text" name="class_desc"><?php $class_id = !empty($class->class_desc)?$class->class_desc:null; echo $class_id;?></textarea>
										</div>
									</div>
