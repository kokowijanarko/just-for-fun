...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title> Tambah Data Tipe Inventaris </title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="<?php echo base_url('index.php/Type/type_add_process')?>" method="POST">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Tipe </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="nama_tipe" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" name="kode_tipe" placeholder="Isi 3 Karakter" class="col-xs-10 col-sm-5" />
										</div>
									</div>
